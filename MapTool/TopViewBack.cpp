...
void CTopViewBack::Render()
{
	...
	if (SelectPt.x != -1)
	{
		...
		vList[0] = { m_vecTile[SelectPt.y][SelectPt.x]->vPos.x - (m_pValueMgr->iTileW >> 1) - m_pMainView->GetScrollPos(0),
		...
		vList[1] = { m_vecTile[SelectPt.y][SelectPt.x]->vPos.x + (m_pValueMgr->iTileW >> 1) - m_pMainView->GetScrollPos(0),
			m_vecTile[SelectPt.y][SelectPt.x]->vPos.y - (m_pValueMgr->iTileH >> 1) - m_pMainView->GetScrollPos(1) };
		vList[2] = { m_vecTile[SelectPt.y][SelectPt.x]->vPos.x + (m_pValueMgr->iTileW >> 1) - m_pMainView->GetScrollPos(0),
			m_vecTile[SelectPt.y][SelectPt.x]->vPos.y + (m_pValueMgr->iTileH >> 1) - m_pMainView->GetScrollPos(1) };
		vList[3] = { m_vecTile[SelectPt.y][SelectPt.x]->vPos.x - (m_pValueMgr->iTileW >> 1) - m_pMainView->GetScrollPos(0),
			m_vecTile[SelectPt.y][SelectPt.x]->vPos.y + (m_pValueMgr->iTileH >> 1) - m_pMainView->GetScrollPos(1) };
		vList[4] = { m_vecTile[SelectPt.y][SelectPt.x]->vPos.x - (m_pValueMgr->iTileW >> 1) - m_pMainView->GetScrollPos(0),
			m_vecTile[SelectPt.y][SelectPt.x]->vPos.y - (m_pValueMgr->iTileH >> 1) - m_pMainView->GetScrollPos(1) };
